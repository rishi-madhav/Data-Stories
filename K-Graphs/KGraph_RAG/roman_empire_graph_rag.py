...
chat = ChatOpenAI(api_key=OPENAI_API_KEY, temperature=0, model_name="gpt-3.5-turbo")
...
raw_documents = WikipediaLoader(query="The Roman_Empire").load()

# Define chunking strategy and create chunks
text_splitter = TokenTextSplitter(chunk_size=512, chunk_overlap=24)
documents = text_splitter.split_documents(raw_documents[:3])  # Limiting to first 3 sections for brevity
print(documents)
